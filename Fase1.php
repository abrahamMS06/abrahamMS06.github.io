...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Verificar que todos los campos requeridos estén presentes en $_POST
    if (isset($_POST['nombre']) && isset($_POST['apellido_P']) && isset($_POST['apellido_M']) && 
        isset($_POST['Numero_boleta']) && isset($_POST['semestre']) && isset($_POST['opcion'])) {
        ...
        $Numero_boleta = htmlspecialchars($_POST['Numero_boleta']);
        $semestre = htmlspecialchars($_POST['semestre']);
        $opcion = htmlspecialchars($_POST['opcion']);

        // Redirigir a Fase2.php con los parámetros GET
        header("Location: Fase2.php?nombre=" . urlencode($nombre) . 
...
<body>
    <div class="form-container">
        ...
        <form id="fase1Form" method="post" action="">
    <!-- Datos personales -->
