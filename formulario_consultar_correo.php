...
<body>
    <div class="form-container">
        ...
        <p>
            ...
            <ul>
                <li>Olvidaste tu Correo Institucional.</li>
                <li>Necesitas Actualizar Tu Correo Institucional.</li>
                <li>Necesitas Unir Tu Correo Institucional con Otro Correo </li>
            </ul>
        </p>
        <p>
        ...
        <ul>
            <li>Comprobante de Estudios (SAES).</li>
            <li>Credencial Escolar por ambos lados.</li>
        </ul>
        <br><br>
        <!-- Formulario de contacto -->
        <form action="CONSULTA_CORREO.PHP" method="post" enctype="multipart/form-data">
