...
<body>
    <div class="form-container">
        ...
        <p>
            ...
            <ul>
                <li>Eres de Nuevo ingreso y no te dio Correo Institucional.</li>
                <li>Cambiaste de Unidad Academica.</li>
                <li>No realizaste Seguimiento a Tu correo.</li>
            </ul>
        </p>
        <p>
        ...
        <form action="SOLICITAR_CORREO_IPN.PHP" method="post" enctype="multipart/form-data">
