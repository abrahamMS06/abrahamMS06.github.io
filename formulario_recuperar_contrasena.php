...
<body>
    ...
    <h1>Aviso</h1>
    <p>Este formulario sirve para los siguientes casos de recuperación de contraseña del correo institucional:</p>
    <ul>
        <li>Olvidaste tu contraseña.</li>
        <li>Tu cuenta fue bloqueada por intentos fallidos.</li>
        <li>No recuerdas tu usuario de acceso.</li>
        <li>Necesitas actualizar tu contraseña por seguridad.</li>
        <li>No recibes correos en tu bandeja de entrada.</li>
        <li>Tu cuenta ha sido desactivada y necesitas reactivarla.</li>
    </ul>
    <p>
    ...
    <p>
        ...
        <ul>
            <li>Comprobante de Inscripcion (SAES)</li>
            <li>Crendecial escolar por ambos lados.</li>
        </ul>
        <br><br>
        <!-- Formulario de contacto -->
        <form action="RECUPERAR_CONTRELLA.PHP" method="post" enctype="multipart/form-data">
         ...
         <label for="Clave_Curp">Clave Curp:</label>
            ...
            <input type="text" id="Correo_Personal" name="Correo_Personal" required><br><br>

            <!-- Campo para el Correo Institucional -->
            <label for="Correo_Institucional">Correo Institucional</label>
            <input type="text" id="Correo_Institucional" name="Correo_Institucional" required><br><br>
