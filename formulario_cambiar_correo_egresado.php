...
<head>
    ...
    <title>Solicitar Cambio de Dominio</title>
    <style>
        /* Estilos generales */
        body {
...
<body>
    <div class="form-container">
        ...
        <p>
            ...
            <ul>
                <li>Eres un alumno que sigue estudiando pero tu correo fue cambiado a @egresado.ipn.mx u otro.</li>
                <li>Eres un Profesor y tu Terminacion de correo fue cambiado.</li>
            </ul>
        </p>
        <p>
        ...
        <form action="CAMBIO_DOMINIO_EGRESADO_A_ALUMNO.PHP" method="post" enctype="multipart/form-data">
           ...
           <label for="nombre">Nombre</label>
            ...
            <!-- Campo para la Carrera Superior que está estudiando -->
            <label for="carrera_superior">Carrera Superior que está estudiando</label>
            <span>licenciatura, maestría, posgrado, doctorado, etc.</span>
            <input type="text" id="carrera_superior" name="carrera_superior" required><br><br>
