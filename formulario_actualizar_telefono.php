...
<body>
    <div class="form-container">
        ...
        <p>
            ...
            <ul>
                <li>Perdiste tu Numero telefonico anterior.</li>
                <li>Utilisas la Verficiacion doble.</li>
                <li>Ya eres Egresado u otro.</li>
            </ul>
        </p>
        <p>
        ...
        <ul>
            <li>Comprobante de Horario (SAES).</li>
        </ul>
        <br><br>
        <!-- Formulario de contacto -->
        <form action="ACTUALIZAR_NUMERO.PHP" method="post" enctype="multipart/form-data">
            ...
            <input type="text" id="apellido_P" name="apellido_P" value="<?php echo htmlspecialchars($apellido_P); ?>" readonly><br><br>

            <!-- Campo para el apellido materno -->
            <label for="apellido_M">Apellido Materno:</label>
            <input type="text" id="apellido_M" name="apellido_M" value="<?php echo htmlspecialchars($apellido_M); ?>" readonly><br><br>


            <!-- Campo para el número de boleta -->
            <label for="Numero_boleta">Número de Boleta:</label>
            <input type="text" id="Numero_boleta" name="Numero_boleta" value="<?php echo htmlspecialchars($Numero_boleta); ?>" readonly><br><br>

            <!-- Campo para el semestre -->
            <label for="semestre">Semestre:</label>
            <input type="text" id="semestre" name="semestre" value="<?php echo htmlspecialchars($semestre); ?>" readonly><br><br>
            ...
            <input type="email" id="Correo_Institucional" name="Correo_Institucional" required><br><br>
             
            <!-- Campo para la Clave Curp -->
            <label for="Clave_Curp">Clave Curp:</label>
            <input type="text" id="Clave_Curp" name="Clave_Curp" required><br><br>

            <!-- Campo para el Nuevo Número telefónico -->
            <label for="Nuevo_Telefono">Nuevo Número telefónico:</label>
            <input type="tel" id="Nuevo_Telefono" name="Nuevo_Telefono" required><br><br>
            ...
            <div class="file-upload">
                ...
                <span>Maximo de espacio 1gb</span>
            </div>
